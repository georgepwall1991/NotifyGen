...
[metadata design](design/property-metadata-forwarding.md),
[accessor-target design](design/accessor-target-metadata.md),
[`PropertyMetadataTests`](../tests/NotifyGen.Tests/PropertyMetadataTests.cs), and
[`Cycle5Tests`](../tests/NotifyGen.Tests/Cycle5Tests.cs).
