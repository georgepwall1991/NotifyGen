> Full feature reference moved from the root README for NotifyGen 2.0.
...
[design proof](https://github.com/georgepwall1991/NotifyGen/blob/master/docs/design/partial-properties.md) and
[`PartialPropertyTests`](https://github.com/georgepwall1991/NotifyGen/blob/master/tests/NotifyGen.Tests/PartialPropertyTests.cs).

### Property Metadata Forwarding

Attributes on an eligible field that are valid for properties are copied to the
generated property. Explicit `[property:]`, `[get:]`, and `[set:]` targets are
also forwarded onto the generated property or accessors (CS0657/CS0658 are
suppressed for `[Notify]` fields). This keeps validation, serialization, and
binding metadata attached without making NotifyGen implement those frameworks:
...
public partial class Person
{
    ...
    [get: System.Obsolete("prefer DisplayLabel")]
...
[metadata design](https://github.com/georgepwall1991/NotifyGen/blob/master/docs/design/property-metadata-forwarding.md),
[accessor-target design](https://github.com/georgepwall1991/NotifyGen/blob/master/docs/design/accessor-target-metadata.md),
[`PropertyMetadataTests`](https://github.com/georgepwall1991/NotifyGen/blob/master/tests/NotifyGen.Tests/PropertyMetadataTests.cs), and
[`Cycle5Tests`](https://github.com/georgepwall1991/NotifyGen/blob/master/tests/NotifyGen.Tests/Cycle5Tests.cs).
...
generated by NotifyGen. See the [target-side dependency design](https://github.com/georgepwall1991/NotifyGen/blob/master/docs/design/notifyalso-target-dependencies.md).
...
[transitive dependency proof](https://github.com/georgepwall1991/NotifyGen/blob/master/docs/design/notifyalso-transitive-cycles.md) and
[`IntegrationTests.NotifyAlso_TransitiveChainAndDiamond_AreDeduplicated`](https://github.com/georgepwall1991/NotifyGen/blob/master/tests/NotifyGen.Tests/IntegrationTests.cs).
...
`INotifyPropertyChanged`. See the [design proof](https://github.com/georgepwall1991/NotifyGen/blob/master/docs/design/notifyalso-subproperty.md)
and [`SubPropertyNotificationTests`](https://github.com/georgepwall1991/NotifyGen/blob/master/tests/NotifyGen.Tests/SubPropertyNotificationTests.cs).
...
See the [collection design proof](https://github.com/georgepwall1991/NotifyGen/blob/master/docs/design/notifyalso-collection-changes.md)
and [`Cycle4Tests`](https://github.com/georgepwall1991/NotifyGen/blob/master/tests/NotifyGen.Tests/Cycle4Tests.cs).
...
[Performance benchmarks](https://github.com/georgepwall1991/NotifyGen/blob/master/benchmarks/NotifyGen.Benchmarks/README.md) compare generated setters with equivalent hand-written notification code:
...
MIT License — use it in personal projects, commercial projects, wherever. See [LICENSE](https://github.com/georgepwall1991/NotifyGen/blob/master/LICENSE) for details.
